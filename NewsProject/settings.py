...
SECRET_KEY = 'django-insecure-omh7^lnyx=i9z6fek)ftbs*g#z=)syog1h8flltqu&b#4foft2'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['sc21ktoc.pythonanywhere.com']
...
SESSION_COOKIE_HTTPONLY = True  # Ensure that the session cookie is only accessible via HTTP
SESSION_COOKIE_SECURE = False  # Set to True if your site is served over HTTPS

# CSRF cookie settings (optional, but recommended for security)
CSRF_COOKIE_NAME = 'csrftoken'  # Name of the CSRF cookie
CSRF_COOKIE_AGE = 3600  # CSRF cookie expiration time in seconds (e.g., 1 hour)
CSRF_COOKIE_SECURE = False  # Set to True if your site is served over HTTPS
CSRF_COOKIE_HTTPONLY = True  # Ensure that the CSRF cookie is only accessible via HTTP
